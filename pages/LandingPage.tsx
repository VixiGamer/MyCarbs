...
const LandingPage: React.FC = () => {
  return (
    <div className="bg-white">
      {/* Navbar */}
      <header className="fixed w-full bg-white/80 backdrop-blur-md z-40 border-b border-slate-100">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-primary-600 rounded-lg flex items-center justify-center text-white font-bold">
                <Wheat className="w-5 h-5" />
            </div>
            <span className="text-xl font-bold tracking-tight text-slate-900">MyCarbs</span>
          </div>
          <Link to="/auth?mode=login" className="text-sm font-semibold text-primary-600 hover:text-primary-700">
            Log In
          </Link>
        </div>
      </header>
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <Link to="/features" className="inline-flex items-center justify-center px-8 py-3.5 text-base font-bold text-slate-700 bg-slate-100 rounded-xl hover:bg-slate-200 transition-all">
                Learn More
              </Link>
            </div>
          </div>
          <div className="flex-1 relative w-full mt-10 md:mt-0">
             <div className="w-full max-w-md mx-auto aspect-square bg-blue-50 rounded-full flex items-center justify-center relative">
               <div className="absolute inset-0 bg-gradient-to-tr from-blue-100 to-transparent rounded-full animate-pulse"></div>
               <Activity className="w-32 h-32 text-primary-200" />
               
               {/* Floating Cards */}
               <div className="absolute top-1/4 -left-2 md:-left-4 bg-white p-4 rounded-xl shadow-xl shadow-slate-200/50 flex items-center gap-3 animate-in slide-in-from-left duration-700 z-10">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-slate-900">25g Carbs</p>
                  </div>
               </div>

               <div className="absolute bottom-1/4 -right-2 md:-right-4 bg-white p-4 rounded-xl shadow-xl shadow-slate-200/50 flex items-center gap-3 animate-in slide-in-from-right duration-700 delay-200 z-10">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-emerald-600">2.5 Units</p>
                  </div>
               </div>
             </div>
          </div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-slate-900">Why MyCarbs?</h2>
            <p className="text-slate-500 mt-2">Built for the daily reality of diabetes.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">Instant Math</h3>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">Personal Database</h3>
              <p className="text-slate-600 leading-relaxed">
      ...
      <footer className="py-8 text-center text-slate-400 text-sm bg-white">
